...
mod6.2 <- glmer(StaySwitch ~ rt_log + prevrt_log + task_phase*since_reversal + prev_choice + prevFeedback*StaySwitch_lag  + (1 | subject), family = binomial, control = glmerControl(optimizer = "bobyqa"), nAGQ = 1, data = data)
...
mod7.2 <- glmer(StaySwitch ~ rt_log + prevrt_log + task_phase*since_reversal*prevFeedback + prevFeedback*StaySwitch_lag + phase_trialnum_z + (1 + prevFeedback + phase_trialnum_z + prevrt_log | subject) + (1 | subject:task_phase), family = binomial, control = glmerControl(optimizer = "bobyqa"), nAGQ = 1, data = data)
