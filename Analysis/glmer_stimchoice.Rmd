...
```{r}
mod4 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.1 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + prev_choice*task_phase*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.2 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + task_phase*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.3 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + task_phase*since_reversal + prev_choice*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.4 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + prev_choice*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.5 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + prevFeedback*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + phase_trialnum_z| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

mod4.6 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + prev_choice*prevFeedback*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + since_reversal| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept

summary(mod4.6)
check_singularity(mod4.6)
car::vif(mod4.6)
...
```{r}
mod5 <- glmer(stim_choice ~ prev_choice*task_phase*prevFeedback + prev_choice*prevFeedback*since_reversal + prev_choice*task_phase*since_reversal + rt_log + prevrt_log + phase_trialnum_z + since_reversal + (0 + prevFeedback |subject:prev_choice) + (1 + since_reversal| subject:task_phase), family="binomial", control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=2e4)), nAGQ = 1, data = data, na.action = na.exclude) # singular intercept
